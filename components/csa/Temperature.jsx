    ...
    render() {
        ...
        return (
            <div>
                ...
                ?
                    <Fragment>  
                        <ModulesDayChart metrica={this.state.metrica} metric="Temperature"  unidad="ºC" metricsDay={this.state.metricsDay} dateData={this.state.dateData}/>
                        <br/>
                            <AverageDayChart metrica={this.state.metrica} metric="Temperature" unidad="ºC" metricsDay={this.state.metricsDay} dateData={this.state.dateData} />
                        <br/>
                            <ModulesMonthChart metrica={this.state.metrica} metric="Temperature" unidad="ºC" metricsMonth={this.state.metricsMonth} dateData={this.state.dateData}/>
                        <br />
                            <AverageMonthChart metrica={this.state.metrica} metric="Temperature" unidad="ºC" metricsMonth={this.state.metricsMonth} dateData={this.state.dateData} />
